  ...
  function saveMedia(type) {
    return $q(function(resolve, reject) {
	       ...
	       var newName = makeid() + name;
               ...
               console.log('ImageService.saveMedia: cordova', cordova);
               console.log('ImageService.saveMedia: cordova.file', cordova.file);
               console.log('ImageService.saveMedia: cordova.file.dataDirectory', cordova.file.dataDirectory);
               console.log('ImageService.saveMedia: $cordovaFile', $cordovaFile);
